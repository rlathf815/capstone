...
public class AIController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Debug.Log("screaming:" + screaming);
        Debug.Log("screamed:" + screamed);
        Debug.Log("chasing:" + chasing);
        Debug.Log("walking:" + walking);
        Debug.Log("needTeleport:" + needTeleport);
        #region Raycast
    ...
    {
        needTeleport = false;
        //Debug.Log("teleportTargetIndex: " + teleportTargetIndex);
